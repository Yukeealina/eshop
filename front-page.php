...
<section class="hero-slider">
		<!-- Single Slider -->
		<div class="single-slider" style="background-image: url(<?php the_field('slider_image'); ?>);">
			<div class="container">
						...
						<div class="text-inner">
							<div class="row">
								<div class="col-lg-7 col-12">
									<div class="hero-text">
										<h1><span>UP TO 10% OFF </span>Cakes for any occasion</h1>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-12">
					<div class="single-banner tab-height">
						...
						<div class="content">
							<p>Flash Sale</p>
							<h3>Bakery Items<br> Up to <span>20%</span> Off</h3>
							<a href="#">Discover Now</a>
						</div>
					</div>
				</div>
						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#Wedding" role="tab">Wedding cake</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Birthdy" role="tab">Birthdy cake</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Mini" role="tab">Mini cakes</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Breads" role="tab">Breads</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#muffins" role="tab">Muffins</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#cookies" role="tab">Cookies</a></li>
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pastries" role="tab">Pastries</a></li>
